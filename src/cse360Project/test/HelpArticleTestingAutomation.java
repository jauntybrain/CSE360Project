...
public class HelpArticleTestingAutomation {
    ...
    public static void main(String[] args) {
        ...
        */
        HelpArticle testHelpArticle = new HelpArticle(testUuid, testTitle, testAuthors,testAbstractText,testKeywords,testBody,testReferences,testGroups,testLevel);
        ...
        */
        char[][] testGroups2 = {"group2".toCharArray(),"group3".toCharArray(),"group4".toCharArray()};
